...
class AmazonIntegrationTest {
    ...
    void testCompleteWorkflow_AddItemAndCalculate() {
        ...
        Item item = new Item(ItemType.OTHER, "Java Programming", 2, 29.99);
    ...
    void testMultipleItems_CalculateTotalPrice() {
        ...
        Item item1 = new Item(ItemType.OTHER, "Clean Code", 1, 35.00);
        Item item2 = new Item(ItemType.ELECTRONIC, "Keyboard", 1, 75.00);
    ...
    void testDatabasePersistence_ItemsRemainAfterAdd() {
        ...
        Item item = new Item(ItemType.OTHER, "T-Shirt", 3, 19.99);
    ...
    void testShoppingCartAdaptor_AddAndRetrieve() {
        ...
        Item item = new Item(ItemType.OTHER, "Apple", 5, 2.50);
    ...
    void testDatabaseReset_ClearsAllData() {
        ...
        Item item = new Item(ItemType.ELECTRONIC, "Phone", 1, 599.99);
        cart.add(item);
    ...
    void testMultiplePriceRules_AppliedInOrder() {
        ...
        Item item = new Item(ItemType.OTHER, "Chair", 2, 150.00);
    ...
    void testElectronicsExtraCost_AppliedCorrectly() {
        ...
        Item electronics = new Item(ItemType.ELECTRONIC, "Laptop", 1, 999.99);
    ...
    void testShoppingCart_HandlesMultipleAdditions() {
        ...
        Item item2 = new Item(ItemType.OTHER, "Book 2", 1, 25.00);
        Item item3 = new Item(ItemType.OTHER, "Book 3", 1, 30.00);
